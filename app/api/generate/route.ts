...
- For decks with 8 or more content slides, insert structure-type slides as section dividers at major narrative transitions. These slides should have only a headline (the section name, e.g., "Challenges", "Evidence", "Recommendations") and optionally a subheadline (a one-line teaser for the upcoming section). Bullets should be empty. Place dividers roughly every 5-8 content slides to create cognitive breathing room.
